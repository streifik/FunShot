...
-(void)start {
    ...
    NSRunLoop *rsad4rwedfun432L_421oop = [NSRunLoop currentRunLoop];
    ...
    [rsad4rwedfun432L_421oop addTimer:_keepAliveTimer forMode:NSDefaultRunLoopMode];
    ...
    while (!_stopRunLoop && [rsad4rwedfun432L_421oop runMode: NSDefaultRunLoopMode beforeDate:loopUntil]) {
